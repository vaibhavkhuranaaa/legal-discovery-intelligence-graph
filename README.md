...
- Responsive evidence review with touch-safe navigation and explicit loading, empty, degraded, refusal, and error states
...
| --- | --- | --- | --- | --- | --- |
| Render | Flask + gunicorn with an ONNX embedding backend | live | anonymous | 2026-08-18T04:20:01Z | No |
